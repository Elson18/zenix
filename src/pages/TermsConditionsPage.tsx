      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-brand-slate text-base leading-relaxed">
          ...
          <div className="space-y-3">
            ...
            <p>
              These terms shall be governed by and construed in accordance with applicable statutory laws. For formal contract inquiries or legal correspondence, contact <span className="font-semibold text-brand-emerald">info@zenixfoodworx.com</span>.
            </p>
          </div>
