...
export default function ReadinessAssessmentPage() {
  ...
  return (
    <div className="pt-24 space-y-0 bg-brand-bgLight min-h-screen flex flex-col justify-between">
      
      {/* Page Hero Header */}
      <section className="py-12 md:py-16 bg-gradient-to-b from-brand-bgWarm via-white to-brand-bgLight border-b border-brand-borderLight no-print">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <h1 className="font-heading font-extrabold text-3xl sm:text-4xl md:text-5xl text-brand-charcoal tracking-tight max-w-3xl mx-auto">
            Food Business Readiness Assessment
          </h1>

          <p className="text-brand-slate text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
